...
export const rootStyles = css`
  :global() {
    :root {
      ...
      --font-letter-spacing-tight: -0.800000011920929px;
      --font-letter-spacing-wide: 0.800000011920929px;
      --z-index-first: 1px;

...
const generateResponsiveStyles = (responsive: ResponsiveProps,  callback: (style: Partial<BoxProps>, key: BreakpointKey) => string) => {
...
const StyledBox = styled.div<BoxProps & { responsive?: ResponsiveProps }>`
  ...
  ${({ responsive }) => responsive
      ? generateResponsiveStyles(responsive, (style) => `
